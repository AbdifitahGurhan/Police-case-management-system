...
const permissions=[
 ...
 ['cases.view','Arag kiis'],['cases.investigate','Baar kiis'],['evidence.manage','Maamul caddeyn'],['suspects.manage','Maamul eedaysane'],
...
const grants={
 ...
 officer:['ob.view','cases.view','cases.investigate','evidence.manage','suspects.manage'], jail:['cases.view','station_jail.view','station_jail.intake','station_jail.assign_cell']
};
async function run(){
