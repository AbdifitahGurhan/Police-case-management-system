...
const { getObEntries, getObEntryById, createObEntry, updateObEntry, changeObStatus, registerAccusedArrest, searchWantedAccused, convertObToCase, resolveObEntry, reopenObEntry, getResolutionDocument, getDeployedOfficersForLocation } = require('../controllers/obEntryController');
...
const COURT_READ_ROLES = ['court', 'court_admin', 'court_clerk', 'judge', 'prosecutor', 'prosecutor_liaison'];
const OB_READ_ROLES = ['admin', 'ob_staff', 'staff', 'officer', 'district_admin', 'cid', 'cid_director', 'cid_supervisor', 'cid_officer', ...COURT_READ_ROLES, ...COMMANDER_ROLES];
